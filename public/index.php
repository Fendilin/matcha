...
$app->post('/homeFilter', '\App\Controller\HomeController:homeFilter')->setName('homeFilter');
...
$app->post('/searchFilter', '\App\Controller\SearchController:searchFilter')->setName('searchFilter');
...
$app->post('/sort-by', '\App\Controller\HomeController:sortBy')->setName('sortBy');
